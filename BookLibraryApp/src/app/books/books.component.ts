...
export class BooksComponent {
  ...
  books:TechnicalBook[]=[
    ...
    new TechnicalBook("6","HTML Basics", "Krish sathe", 609.99, new Date("20 Aug 2004"), "this is web basics book"),
    new TechnicalBook("4","Web Basics", "Krish sathe", 607, new Date("20 Aug 2023"), "this is web basics book")
  ]
}
